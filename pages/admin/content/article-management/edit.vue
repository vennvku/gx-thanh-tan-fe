...
export default {
  ...
  head() {
    return {
      title: `${this.$t('title')} | ${this.$t(
        'admin.page.articleManagementEdit'
      )}`,
    }
  },
  computed: {
  ...
  watch: {
    article: {
      handler(data) {
        if (data) {
          this.titleVi = data.translations.vi.title
          this.titleEn = data.translations.en.title
          this.descriptionVi = data.translations.vi.description
          this.descriptionEn = data.translations.en.description

          this.contentVi = data.translations.vi.content
          this.contentEn = data.translations.en.content

          this.selectedPublish = data.is_show
          this.checkFeature = data.is_featured

          this.selectedCategory = data.categories.id
        }
      },
    },
    categories: {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$store.dispatch('admin/article/article/update', {
